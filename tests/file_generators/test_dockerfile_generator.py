...
def test_generate_dockerfile(dockerfile_generator, mock_config):
    ...
    dockerfile_content = dockerfile_generator.generate_dockerfile(project_name)
...
def test_generate(dockerfile_generator):
    ...
    dockerfile_generator.generate(project_name)
    dockerfile_generator.generate_dockerfile.assert_called_once_with(project_name)
