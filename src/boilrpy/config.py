class Config:
    ...
    def __init__(self):
        ...
        self.available_dep_managers = ["pip", "poetry", "uv", "conda"]
    ...
    def get_available_dep_managers(self) -> list:
        """Returns a list of available dependency managers."""
        return self.available_dep_managers
